...
with col_list:
    ...
    if not filtered:
        ...
        for f in filtered[:20]:
            ...
            # Couleur et animation selon sévérité
            if raw_sev == "Extreme":
                border_color = "#FF3B30"
